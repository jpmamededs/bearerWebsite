            ...
            <nav className="navbar border-b-3 border-b-black flex flex-col justify-center items-center">
                ...
                >
                    <ul className="flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-8 lg:gap-16 xl:gap-40 w-full md:w-[80%] justify-center items-center text-center md:text-left py-4 sm:py-3 md:py-2 px-2 text-sm sm:text-base" style={{fontWeight: 650}}>
                        <li><a href="https://api.whatsapp.com/send/?phone=5511967921313&text&type=phone_number&app_absent=0&wame_ctl=1&source_surface=20" style={{transition: 'color 0.2s ease'}} onMouseEnter={(e) => e.target.style.color = '#ff353a'} onMouseLeave={(e) => e.target.style.color = 'inherit'} className="flex flex-row items-center justify-center gap-1">Whatsapp<LuExternalLink /></a></li>
                        <li><a href="https://www.instagram.com/sejabearer.com.br/" target="_blank" rel="noopener noreferrer" style={{transition: 'color 0.2s ease'}} onMouseEnter={(e) => e.target.style.color = '#ff353a'} onMouseLeave={(e) => e.target.style.color = 'inherit'} className="flex flex-row items-center justify-center gap-1">Instagram<LuExternalLink /></a></li>
