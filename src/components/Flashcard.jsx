function Flashcard({ numero, titulo, descricao }) {
    return (
        <>
            <div className="w-full sm:w-[20rem] md:w-[21rem] h-[15rem] sm:h-[20rem] md:h-[21rem] border-3 flex flex-col p-6 sm:p-8 md:p-10 gap-3 sm:gap-4 items-left justify-between bg-[#FBF6C1]">
